...
if not st.session_state["logged_in"]:
    st.title("🔐 Login Dashboard Monitoring Kenaikan Pangkat Guru & Pengawas Disdik Sumut")
    ...
    try:
        ...
        # --- TAMPILAN UTAMA ---
        st.title("📊 Dashboard Monitoring Kenaikan Pangkat Guru & Pengawas Disdik Sumut")
